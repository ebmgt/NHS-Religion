...
# Printing the regression results for PLOS One -----
# Tidy model output
tbl <- broom::tidy(model_temp)
...
txt <- capture.output(summary(model_temp))
writeLines(txt, "S1_table (no header or footer).txt")
